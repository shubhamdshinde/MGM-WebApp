...
<div class="main_login">
	...
	<form action="" method="post">
		...
		<input type="text" class="button1" placeholder="<?php echo $_SESSION['name']; ?>" disabled required />
		<input type="text" class="button1" placeholder="<?php echo $_SESSION['email']; ?>" disabled required />
		<input type="text" class="button1" placeholder="<?php echo $_SESSION['mobile']; ?>" disabled required />
		<input type="text" class="button1" placeholder="<?php echo $_SESSION['class']; ?>" disabled required />
		<br>
